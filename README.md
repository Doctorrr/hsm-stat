...
Позволяет контролировать количество пакетов при нагрузке и следить за лимитами лицензий

Формат запуска: java - jar hsm_stat.jar <filename> <alert_quantity=50> <mode=default/verbose>
